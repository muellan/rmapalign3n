...
#ifndef RMA_CONFIG_H_
#define RMA_CONFIG_H_
 ...
 */
#ifdef RMA_TARGET_ID_TYPE
    using target_id = RMA_TARGET_ID_TYPE ;
#else
 ...
 */
#ifdef RMA_WINDOW_ID_TYPE
    using window_id = RMA_WINDOW_ID_TYPE ;
#else
 ...
 */
#ifdef RMA_LOCATION_LIST_SIZE_TYPE
    using loclist_size_t = RMA_LOCATION_LIST_SIZE_TYPE ;
#else
