...
#ifndef RMA_CMDLINE_INTERFACE_H_
#define RMA_CMDLINE_INTERFACE_H_
...
struct sketching_options
{
    ...
    // 3N conversion setting (original -> replacement)
    char convOrig = 'C';
    char convRepl = 'T';
};
 ...
 *          reflects the output format of the first public RmapAlign3N
 *          version.
 *
 *****************************************************************************/
